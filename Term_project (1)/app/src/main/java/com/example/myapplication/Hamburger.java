...
public class Hamburger extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        upldImg = findViewById(R.id.uploadImage);

        FirebaseUser currentUser = FirebaseAuth.getInstance().getCurrentUser();
        if (currentUser != null) {
            DatabaseReference user_ref = FirebaseDatabase.getInstance().getReference("users").child(currentUser.getUid());
            user_ref.addValueEventListener(new ValueEventListener() {
                                              ...
                                              public void onCancelled(@NonNull DatabaseError error) {
                                                  Toast.makeText(Hamburger.this, getString(R.string.somethingwrong), Toast.LENGTH_LONG).show();
                                              }
                ...
                new ActivityResultCallback<ActivityResult>() {
                    ...
                    public void onActivityResult(ActivityResult result) {
                        if (result.getResultCode() == Activity.RESULT_OK){
                            ...
                            upldImg.setImageURI(img_uri);
                        } else {
                            Toast.makeText(Hamburger.this, getString(R.string.noimage), Toast.LENGTH_SHORT).show();
                        }
                    }
                }
        );
        ...
        uploadBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (img_uri != null){
                    ...
                    Toast.makeText(Hamburger.this, getString(R.string.selectimage), Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
                            ...
                            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                                imageReference.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                    ...
                                    public void onSuccess(Uri uri) {
                                        ...
                                        Toast.makeText(Hamburger.this, getString(R.string.uploaded), Toast.LENGTH_SHORT).show();
                                        Intent intent = new Intent(Hamburger.this, MainActivity.class);
    ...
    public void showDialogOrToast(String truncatedCaption, String fullCaption) {
        ...
        Toast.makeText(Hamburger.this, fullCaption, Toast.LENGTH_LONG).show();
    }
