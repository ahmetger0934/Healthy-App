...
public class Meatballs extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FirebaseUser curnt_user = FirebaseAuth.getInstance().getCurrentUser();
        if (curnt_user != null) {
            DatabaseReference userRef = FirebaseDatabase.getInstance().getReference("users").child(curnt_user.getUid());
            userRef.addValueEventListener(new ValueEventListener() {
                                              ...
                                              public void onCancelled(@NonNull DatabaseError error) {
                                                  Toast.makeText(Meatballs.this, getString(R.string.somethingwrong), Toast.LENGTH_LONG).show();
                                              }
                ...
                new ActivityResultCallback<ActivityResult>() {
                    ...
                    public void onActivityResult(ActivityResult result) {
                        if (result.getResultCode() == Activity.RESULT_OK){
                            ...
                            Toast.makeText(Meatballs.this, getString(R.string.noimage), Toast.LENGTH_SHORT).show();
                        }
                    }
                }
        );
        ...
        uploadButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (img_uri != null){
                    ...
                    Toast.makeText(Meatballs.this, getString(R.string.selectimage), Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    public void uploadToFirebase(Uri uri){
        ...
        final StorageReference img_ref = storageReference.child(System.currentTimeMillis() + "." + getFileExtension(uri));
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                if (task.isSuccessful()) {
                    ...
                    if (document.exists()) {
                        ...
                        img_ref.putFile(uri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                            @Override
                            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                                img_ref.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                    ...
                                    public void onSuccess(Uri uri) {
                                        ...
                                        Toast.makeText(Meatballs.this, getString(R.string.uploaded), Toast.LENGTH_SHORT).show();
                                        Intent intent = new Intent(Meatballs.this, MainActivity.class);
    ...
    public void showDialogOrToast(String truncatedCaption, String fullCaption) {
        ...
        Toast.makeText(Meatballs.this, fullCaption, Toast.LENGTH_LONG).show();
    }
