...
public class Salad extends AppCompatActivity {
    ...
    Uri img_uri;
    final DatabaseReference db_ref = FirebaseDatabase.getInstance().getReference("Images");
    final StorageReference storage_ref = FirebaseStorage.getInstance().getReference();
        ...
        if (currentUser != null) {
            ...
            userRef.addValueEventListener(new ValueEventListener() {
                                              ...
                                              public void onCancelled(@NonNull DatabaseError error) {
                                                  Toast.makeText(Salad.this, getString(R.string.somethingwrong), Toast.LENGTH_LONG).show();
                                              }
                ...
                new ActivityResultCallback<ActivityResult>() {
                    ...
                    public void onActivityResult(ActivityResult result) {
                        if (result.getResultCode() == Activity.RESULT_OK){
                            ...
                            Toast.makeText(Salad.this, getString(R.string.noimage), Toast.LENGTH_SHORT).show();
                        }
                    }
                }
        );
        ...
        uploadButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (img_uri != null){
                    ...
                    Toast.makeText(Salad.this, getString(R.string.selectimage), Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
                            ...
                            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                                imageReference.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                    ...
                                    public void onSuccess(Uri uri) {
                                        ...
                                        Toast.makeText(Salad.this, getString(R.string.uploaded), Toast.LENGTH_SHORT).show();
                                        Intent intent = new Intent(Salad.this, MainActivity.class);
    ...
    public void showDialogOrToast(String truncatedCaption, String fullCaption) {
        ...
        Toast.makeText(Salad.this, fullCaption, Toast.LENGTH_LONG).show();
    }
