...
public class Pizza extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        upld_img = findViewById(R.id.uploadImage);
        ...
        if (currentUser != null) {
            ...
            userRef.addValueEventListener(new ValueEventListener() {
                                              ...
                                              public void onCancelled(@NonNull DatabaseError error) {
                                                  Toast.makeText(Pizza.this, getString(R.string.somethingwrong), Toast.LENGTH_LONG).show();
                                              }
                ...
                new ActivityResultCallback<ActivityResult>() {
                    ...
                    public void onActivityResult(ActivityResult result) {
                        if (result.getResultCode() == Activity.RESULT_OK){
                            ...
                            upld_img.setImageURI(img_uri);
                        } else {
                            Toast.makeText(Pizza.this, getString(R.string.noimage), Toast.LENGTH_SHORT).show();
                        }
                    }
                }
        );
        ...
        uploadButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (img_uri != null){
                    ...
                    Toast.makeText(Pizza.this, getString(R.string.selectimage), Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    public void uploadToFirebase(Uri uri){
        ...
        if (caption.length() > maxCaptionLength) {
            ...
            this.caption.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    // Show the complete caption in a dialog or toast message
                            ...
                            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                                imageReference.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                    ...
                                    public void onSuccess(Uri uri) {
                                        ...
                                        Toast.makeText(Pizza.this, getString(R.string.uploaded), Toast.LENGTH_SHORT).show();
    ...
    public void showDialogOrToast(String truncatedCaption, String fullCaption) {
        ...
        Toast.makeText(Pizza.this, fullCaption, Toast.LENGTH_LONG).show();
    }
